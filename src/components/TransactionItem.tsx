...
export function TransactionItem({ 
  ...
  return (
    <div
      onClick={onEdit}
      className={cn(
        "interactive-card flex items-center gap-3 rounded-2xl p-4 cursor-pointer bg-card border border-border/40 transition-all group/item relative overflow-hidden active:scale-[0.98] sm:pr-4 pr-[48px] shadow-sm hover:shadow-md"
      )}
      style={style}
    >
      {onDelete && (
