...
import { ArrowLeft, Plus, Landmark, Trash2, X, Check, Loader2, Upload, FileText, MoreVertical, GripVertical, Pencil, Eye, EyeOff, CheckSquare, Square, Filter, FilterX, Search, SlidersHorizontal } from "lucide-react";
...
function AccountsPage() {
  ...
  return (
    <div className="animate-page-enter mx-auto w-full max-w-4xl flex flex-col gap-8 px-2 sm:px-4 pt-6 pb-28">
